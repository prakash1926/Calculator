...
namespace SpecFlowProjectAssessment.Features
{
...
#line hidden
        ...
        public Calculator1Feature(Calculator1Feature.FixtureData fixtureData, SpecFlowProjectAssessment_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Multiple two numbers")]
        [Xunit.TraitAttribute("FeatureTitle", "Calculator1")]
        [Xunit.TraitAttribute("Description", "Multiple two numbers")]
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 24
 testRunner.Given("The first number is 36", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 25
